...
/**
 * Always choose the operation from the job with the longest processing time, without the operation under consideration
 */
public class LRMStrategy implements ChoiceStrategy {
